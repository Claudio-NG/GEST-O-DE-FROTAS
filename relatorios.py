# relatorios.py — pequenos ajustes de robustez (nenhuma mudança de UX)
...
from PyQt6.QtWidgets import (
    ...
    QTableWidgetItem, QGridLayout, QProgressBar, QFileDialog, QInputDialog
)

from utils import (
    THEME, apply_shadow, load_df, ensure_datetime, apply_period,
    run_tasks, export_to_csv, export_to_excel,
...
class RelatoriosView(BaseView):
    def __init__(self):
        ...
        # renomeia botão padrão da barra de período
